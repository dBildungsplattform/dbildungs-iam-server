...
import { StatusInfoHelpers } from '../technical/utils/status-info.utils.js';

@Injectable()
export class ItslearningGroupAdapter {
    public constructor(private readonly itslearningService: ItsLearningIMSESApiService) {}
