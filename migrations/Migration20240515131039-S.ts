...
export class Migration20240515131039 extends Migration {
    async up(): Promise<void> {
        ...
        this.addSql(
            'create table "data_provider" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "data_provider_pkey" primary key ("id"));',
        );
        ...
        this.addSql(
            'alter table "person" add constraint "person_data_provider_id_foreign" foreign key ("data_provider_id") references "data_provider" ("id") on update cascade on delete set null;',
        );
        ...
        this.addSql(
            'alter table "rolle_merkmal" add constraint "rolle_merkmal_rolle_id_foreign" foreign key ("rolle_id") references "rolle" ("id") on update cascade;',
        );

        this.addSql(
            'alter table "rolle_systemrecht" add constraint "rolle_systemrecht_rolle_id_foreign" foreign key ("rolle_id") references "rolle" ("id") on update cascade;',
        );
        ...
        this.addSql(
            'alter table "rolle_service_provider" add constraint "rolle_service_provider_rolle_id_foreign" foreign key ("rolle_id") references "rolle" ("id") on update cascade;',
        );
        this.addSql(
            'alter table "rolle_service_provider" add constraint "rolle_service_provider_service_provider_id_foreign" foreign key ("service_provider_id") references "service_provider" ("id") on update cascade;',
        );
    }
}
