...
export class LoginController {
    ...
    @Post()
    @UseFilters(new KeyCloakExceptionFilter(HttpStatus.SERVICE_UNAVAILABLE),
    ...
    @ApiNotFoundResponse({description: 'USER_AUTHENTICATION_FAILED_ERROR: User could not be authenticated successfully.'})
