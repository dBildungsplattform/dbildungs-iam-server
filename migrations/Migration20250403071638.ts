...
export class Migration20250403071638 extends Migration {
    public async up(): Promise<void> {
        ...
        this.addSql('create index "external_id_person_index" on "external_id_mapping" ("person_id");');

        this.addSql(
            'alter table "external_id_mapping" add constraint "external_id_mapping_person_id_foreign" foreign key ("person_id") references "person" ("id") on update cascade;',
        );
    }
