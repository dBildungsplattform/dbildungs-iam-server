...
import { ItsLearningIMSESApiService } from './itslearning.api-service.js';
...
describe('ItsLearningIMSESApiService', () => {
    let module: TestingModule;
    let sut: ItsLearningIMSESApiService;
    ...
    beforeAll(async () => {
        ...
        sut = module.get(ItsLearningIMSESApiService);
