...
export class Migration20240722092146 extends Migration {
    async up() {
        ...
        this.addSql('create unique index "person_keycloak_user_id_unique" on "person" ("keycloak_user_id") nulls not distinct;;');
        this.addSql('create unique index "person_personalnummer_unique" on "person" ("personalnummer") nulls distinct;;');
...
//# sourceMappingURL=Migration20240722092146.js.map