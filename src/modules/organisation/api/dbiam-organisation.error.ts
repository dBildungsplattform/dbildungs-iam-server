...
export enum OrganisationSpecificationErrorI18nTypes {
    ...
    NEWER_VERSION_ORGANISATION = 'NEWER_VERSION_ORGANISATION',
    ORGANISATION_WECHSELT_TEILBAUM = 'ORGANISATION_WECHSELT_TEILBAUM',
    ORGANISATION_ZUWEISUNG_FEHLER = 'ORGANISATION_ZUWEISUNG_FEHLER',
    SCHULTRAEGER_NAME_EINDEUTIG = 'SCHULTRAEGER_NAME_EINDEUTIG',
    ORGANISATION_HAT_KINDER = 'ORGANISATION_HAT_KINDER',
    ORGANISATION_HAT_ZUGEHOERIGE = 'ORGANISATION_HAT_ZUGEHOERIGE',
    ORGANISATION_HAT_ROLLEN = 'ORGANISATION_HAT_ROLLEN',
    ORGANISATION_HAT_PERSONENKONTEXTE = 'ORGANISATION_HAT_PERSONENKONTEXTE',
    ORGANISATION_HAT_ANGEBOTE = 'ORGANISATION_HAT_ANGEBOTE',
    ORGANISATION_HAT_ROLLENERWEITERUNGEN = 'ORGANISATION_HAT_ROLLENERWEITERUNGEN',
}
