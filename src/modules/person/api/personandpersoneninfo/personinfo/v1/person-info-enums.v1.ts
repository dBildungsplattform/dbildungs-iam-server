...
export function convertRollenartToPersonInfoKontextV1Rolle(rollenart: RollenArt): PersonInfoKontextV1Rolle {
    switch (rollenart) {
        case RollenArt.LERN:
            return PersonInfoKontextV1Rolle.LERN;
        case RollenArt.LEHR:
            return PersonInfoKontextV1Rolle.LEHR;
        case RollenArt.LEIT:
            return PersonInfoKontextV1Rolle.LEIT;
        case RollenArt.SYSADMIN:
            return PersonInfoKontextV1Rolle.SYSADMIN;
        case RollenArt.ORGADMIN:
            return PersonInfoKontextV1Rolle.ORGADMIN;
        case RollenArt.EXTERN:
            return PersonInfoKontextV1Rolle.EXTERN;
    }
}
