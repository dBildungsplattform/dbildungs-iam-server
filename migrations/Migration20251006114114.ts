...
export class Migration20251006114114 extends Migration {
    async up(): Promise<void> {
        this.addSql(
            'alter table "person" drop column "initialen_familienname", drop column "initialen_vorname", drop column "rufname", drop column "geburtsdatum", drop column "geburtsort", drop column "geschlecht", drop column "vertrauensstufe", drop column "auskunftssperre";',
        );
