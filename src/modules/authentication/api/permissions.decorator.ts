...
export const Permissions: (...dataOrPipes: (Type<PipeTransform> | PipeTransform<any, any> | unknown[])[]) => ParameterDecorator =
    createParamDecorator((_data: unknown, ctx: ExecutionContext): Promise<PersonPermissions | undefined> => {
