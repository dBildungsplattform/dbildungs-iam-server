...
export class RolleController {
    public constructor(
        ...
        private readonly applyRollenerweiterungService: ApplyRollenerweiterungWithRolleForAngeboteService,
    ) {}
    ...
    @Get(':rolleId/angeboteViaRollenerweiterungen')
    ...
    public async applyRollenerweiterungChangesForRolle(
        ...
        > = await this.applyRollenerweiterungService.applyRollenerweiterungChangesWithRolleForAngebote(
            params.organisationId,
            params.rolleId,
            body,
            permissions,
