...
export class Migration20250930063451 extends Migration {
    public async up(): Promise<void> {
        ...
        this.addSql(
            'alter table "email"."address_status" add constraint "address_status_email_address_id_foreign" foreign key ("email_address_id") references "email"."address" ("id") on delete cascade;',
        );
    }
