...
/*
    These tests run without proper LDAP configuration and running LDAP, to test failing of some methods.
    The errors returned are not checked, these tests are for coverage only.
 */
describe('LDAP Test Without Running LDAP', () => {
