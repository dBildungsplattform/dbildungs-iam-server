...
import { Constructor, FlexibleKeepAliveHandler, TypedMethodDecorator } from '../types/util.types.js';
...
): TypedMethodDecorator<ClassType, MethodName, FlexibleKeepAliveHandler<Event>> {
