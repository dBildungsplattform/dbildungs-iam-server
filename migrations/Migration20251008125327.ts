...
export class Migration20251008125327 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "person" drop column "initialen_familienname", drop column "initialen_vorname", drop column "rufname", drop column "name_titel", drop column "name_anrede", drop column "name_praefix", drop column "name_suffix", drop column "name_sortierindex", drop column "geburtsdatum", drop column "geburtsort", drop column "geschlecht", drop column "lokalisierung", drop column "vertrauensstufe", drop column "auskunftssperre";');
