...
export enum RolleErrorI18nTypes {
    ...
    ROLLE_NAME_UNIQUE_ON_SSK = 'ROLLE_NAME_UNIQUE_ON_SSK',
    SERVICE_PROVIDER_NICHT_NACHTRAEGLICH_ZUWEISBAR = 'SERVICE_PROVIDER_NICHT_NACHTRAEGLICH_ZUWEISBAR',
    SERVICE_PROVIDER_NICHT_VERFUEGBAR_FUER_ROLLENERWEITERUNG = 'SERVICE_PROVIDER_NICHT_VERFUEGBAR_FUER_ROLLENERWEITERUNG',
